...
makeAnimatedLuaSprite('BG1', 'Sus/defeat/defeat', -950, -300);
...
makeLuaSprite('BG3', 'Sus/defeat/deadBG', -640, 450);
scaleObject('BG3', 0.8, 0.8);
makeLuaSprite('BG4', 'Sus/defeat/iluminao omaga', -450, -100);
makeLuaSprite('BG5', 'Sus/defeat/deadFG', -700, 750);
scaleObject('BG5', 0.8, 0.8);
